...
public class EmployeeController {
    ...
    // Endpoint with pagination and sorting for employee list
    ...
    public Page<Employee> getAllEmployeesPaginated(
        ...
        return employeeService.getAllEmployeesPaginated(page, size, sortField, sortDirection);
    }

    // Search employees by name with pagination and sorting
    @GetMapping("/search/paginated")
    public Page<Employee> searchEmployeesByNameWithPagination(
            @RequestParam String name,
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size,
            @RequestParam(defaultValue = "name") String sortField,
            @RequestParam(defaultValue = "asc") String sortDirection) {
        return employeeService.searchEmployeesByNameWithPagination(name, page, size, sortField, sortDirection);
    }
}
